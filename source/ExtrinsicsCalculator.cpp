...
void ExtrinsicsCalculator::eightPointMatching(std::vector<PointPair> matching_points_)
{
...
/*
void ExtrinsicsCalculator::multiplyIntrinsics(std::vector<PointPair> matching_points_)
{
